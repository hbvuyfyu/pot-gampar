...
ADMIN_MENU, PAYMENT_MENU, PLAN_MENU = range(300, 303)
(
    ...
    PLAN_ADD_NAME, PLAN_ADD_DURATION, PLAN_ADD_PRICE, PLAN_ADD_LIMIT, PLAN_EDIT_NAME, PLAN_EDIT_DURATION, PLAN_EDIT_PRICE, PLAN_EDIT_LIMIT,
) = range(600, 632)
